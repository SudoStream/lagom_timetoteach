package io.sudostream.timetoteach.api
...
object TimetoteachService  {
  val TOPIC_NAME = "greetings"
}

/**
  * The timetoteach service interface.
  * <p>
  * This describes everything that Lagom needs to know about how to serve and
  * consume the TimetoteachService.
  */
trait TimetoteachService extends Service {
  ...
  override final def descriptor = {
    ...
    named("timetoteach")
      ...
      .withTopics(
        topic(TimetoteachService.TOPIC_NAME, greetingsTopic _)
